...
Thsi project focuses on analyzing a coffee sales dataset downloaded from [here](https://mavenanalytics.io/data-playground?order=date_added%2Cdesc&search=coffee%20sales%20) to anlyze the sales trends, product performanc and store-wise distribution. The analysis conducted using Mirosoft Excel and Power Query Editor to clean, transform and visualize the data.

## Objective 
The primary objective of this project is to provide a clear understanding of customers purchasing pattern, identify top products and store locations and highlight the insights through visuals. These insights will be helpful for decision-making for sales, marketing and inventory management.

# Recommended Analytical Questions
Here are the key questions that need to analysed and visualised.
...
![](https://github.com/Roma90527/Coffee_Sales_Analysis---Excel-Dashboard-/blob/main/Screenshot/Order-per-month.png?raw=true)
...
![](https://github.com/Roma90527/Coffee_Sales_Analysis---Excel-Dashboard-/blob/main/Screenshot/number%20of%20order%20weekdays%20.png?raw=true)
...
![](https://github.com/Roma90527/Coffee_Sales_Analysis---Excel-Dashboard-/blob/main/Screenshot/number%20of%20order%20per%20hour%20.png?raw=true)
...
![](https://github.com/Roma90527/Coffee_Sales_Analysis---Excel-Dashboard-/blob/main/Screenshot/Top%20five%20products.png?raw=true)
...
![](https://github.com/Roma90527/Coffee_Sales_Analysis---Excel-Dashboard-/blob/main/Screenshot/distribution%20of%20product%20categories%20.png?raw=true)
...
![](https://github.com/Roma90527/Coffee_Sales_Analysis---Excel-Dashboard-/blob/main/Screenshot/size%20distribution%20based%20on%20order%20.png?raw=true)

**Question 7:** Which store location have highest customer traffic(footfall)?  
All three store locations show consistently high footfall, each serving over 47,000 customers within the time period analyzed. **Hell's Kitchen leads slightly in both footfall (50,735)** and **total sales($236,511.17)** indicating high throughput and high value transactions. **Astoria follows closely** with 50,599 customers and $232,243.91 in revenue. While **Lower Manhattan** has slightly lower footfall(47,782), its **total sales($230,057.25)** are comparable, suggesting higher **average bill per customer** at this location. These insights can guide **location-specific promotions** , staffing and **inventory decisions**. The visualisation of ![](https://github.com/Roma90527/Coffee_Sales_Analysis---Excel-Dashboard-/blob/main/Screenshot/Footfall%20over%20various%20stores%20.png?raw=true)
